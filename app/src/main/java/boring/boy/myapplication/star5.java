...
public class star5 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences star_editor = getSharedPreferences("star4", MODE_PRIVATE);
        SharedPreferences test_editor = getSharedPreferences("test5", MODE_PRIVATE);
    ...
    public void go_next(View v){
        ...
        Intent it =new Intent(this,end.class) ;
