...
public class star4 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences stareditor = getSharedPreferences("star3", MODE_PRIVATE);
        SharedPreferences testeditor = getSharedPreferences("test4", MODE_PRIVATE);
        String question = testeditor.getString("question","");
        String answer[] = testeditor.getString("answer","").split(",");
        choose = testeditor.getInt("choose",99);
    ...
    public void go_next(View v){
        ...
        Intent it =new Intent(this,star5.class) ;
        editor2.putInt("答對",count);
        editor2.commit();
        startActivity(it);
        finish();
    }
