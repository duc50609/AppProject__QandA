...
implements RadioGroup.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences test_editor = getSharedPreferences("test1", MODE_PRIVATE);
    ...
    public void go_next(View v){
        SharedPreferences.Editor stat_editor = getPreferences(MODE_PRIVATE).edit();
        stat_editor.putInt("答對",count);
        stat_editor.commit();
        Intent it =new Intent(this,star2.class) ;
        startActivity(it);
        finish();
    }
    @Override
