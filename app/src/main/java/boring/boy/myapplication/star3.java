...
public class star3 extends AppCompatActivity
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            SharedPreferences star_editor = getSharedPreferences("star2", MODE_PRIVATE);
            SharedPreferences test_editor = getSharedPreferences("test3", MODE_PRIVATE);
        ...
        public void go_next(View v){
            ...
            Intent it =new Intent(this,star4.class) ;
